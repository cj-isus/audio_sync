// ============================================================================================
// КОНВЕНЦИЯ ДЛЯ BENCHMARK ТЕСТОВ
// ============================================================================================
// ОБНОВЛЕНО НА ИЮЛЬ 2025: Gradle 9.0.0, Kotlin 2.2.0, JDK 21, AGP 8.10.0
// Стандартизирует конфигурацию для модулей тестирования производительности
// ============================================================================================
...
android {
    namespace = "ru.audiosynchronizer.tests"
...
dependencies {
    // Базовые зависимости для benchmark тестов
